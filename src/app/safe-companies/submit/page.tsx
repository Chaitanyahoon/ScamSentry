  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "The company has been submitted and is awaiting administrator review.",
      });
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-sm text-muted-foreground max-w-md mx-auto">
              Recommend a trustworthy company or client with a track record of
              fair practices and reliable payments.
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl shadow-xl overflow-hidden mb-8">
            <div className="border-b border-border bg-muted/30 px-6 py-4">
              <h2 className="text-sm font-semibold text-foreground flex items-center gap-2">
                <ShieldCheck className="h-4.5 w-4.5 text-success" /> Company
            ...
            <div className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-success/5 border border-success/10 rounded-xl p-4 space-y-3">
                  <Label
                    htmlFor="captcha"
                    className="text-xs font-semibold text-success block"
                  >
                    Security Verification: Solve the problem{" "}
          ...
          <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
            ...
            <ul className="space-y-2.5 text-xs text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <strong>Accurate Information:</strong> Only submit verified and
                real company details and website URLs.
              </li>
              <li className="flex items-start gap-2">
                <span className="text-success font-bold">•</span>
                <strong>No Self-Promotion:</strong> Submissions created to
                artificially boost your own rating will be removed.
              </li>
              <li className="flex items-start gap-2">
                <span className="text-success font-bold">•</span>
                <strong>Moderator Oversight:</strong> Submissions must pass
                administrative audit before appearing on the public ledger.
              </li>
            </ul>
          </div>
        </div>
