      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground max-w-sm">
            The requested domain could not be found in the Forensic intelligence
            database.
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-4">
                    {forensics.flags.map((flag, i) => (
                      <li
                        key={i}
                        className="flex gap-4 items-start p-3 bg-red-500/5 border border-red-500/10 rounded-lg group hover:bg-red-500/10 transition-colors"
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs font-bold text-foreground truncate">
                              {forensics.infrastructure?.registrar ||
                                "REDACTED"}
                            </p>
                          </div>
                        </div>
