...
/**
 * Terms of Use page.
 * Styled in "Forensic Amber" terminal layout matching the Privacy Policy.
 */
        ...
        <div className="flex items-center gap-4 border-b border-[#1F1914] pb-6">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground uppercase tracking-wider mt-1">
              Platform Usage Covenant & Forensic Disclaimer
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 text-xs leading-relaxed text-muted-foreground">
          <section className="space-y-2">
            <h2 className="text-sm font-bold text-primary uppercase tracking-widest flex items-center gap-2">
              <ShieldAlert className="h-3 w-3" /> 1. SYSTEM INTENT & ACCEPTABLE
              USE
            </h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-bold text-primary uppercase tracking-widest flex items-center gap-2">
              <ShieldAlert className="h-3 w-3" /> 2. ADVISORY THREAT DOSSIERS
            </h2>
            <p>
              ...
              rests with the workstation operator.
            </p>
          </section>

          <section className="space-y-2">
            <h2 className="text-sm font-bold text-primary uppercase tracking-widest flex items-center gap-2">
              <ShieldAlert className="h-3 w-3" /> 3. SOURCE INTEGRITY & CREDITS
            </h2>
            <p>
