        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-base text-muted-foreground max-w-xl mx-auto">
              Your report has been securely logged and is pending moderator
              verification. Thank you for contributing to the community
              database.
            </p>
          </div>
          ...
          <div className="mb-12 bg-card border border-border p-6 sm:p-8">
            ...
            <div className="mx-auto bg-background border border-border p-4 shadow-sm">
              {reportUrl && (
                <ShareableReportCard report={report} reportUrl={reportUrl} />
              )}
            </div>
          </div>
