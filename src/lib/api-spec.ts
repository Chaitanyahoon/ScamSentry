...
export const openApiSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Deterministic 4-layer URL threat detection and validation system",
    contact: {
  ...
  paths: {
    "/api/validator": {
      post: {
        ...
        description:
          "Scan a single URL and get detailed forensic analysis (No authentication required)",
    ...
    "/api/v1/validate": {
      post: {
        ...
        description:
          "Production-grade API for enterprise integrations with rate limiting",
                        ...
                        diagnostics: {
                          ...
                          properties: {
                            layers: {
                              ...
                              properties: {
                                heuristics: {
                                  $ref: "#/components/schemas/LayerDiagnostic",
                                },
                                forensics: {
                                  $ref: "#/components/schemas/LayerDiagnostic",
                                },
    ...
    "/api/v1/verify": {
      post: {
        ...
        description:
          "Secure endpoint for verified integrations with API key authentication",
