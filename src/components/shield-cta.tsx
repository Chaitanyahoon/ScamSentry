  ...
  const features = [
    {
      ...
      description:
        "Heuristic engine runs locally on every link before you click.",
    },
    {
      icon: <Search className="h-4 w-4 text-primary" />,
      title: "Structural DNA Audit",
      description:
        "Detects pixel-perfect clones and punycode homograph attacks.",
    },
    {
      icon: <Lock className="h-4 w-4 text-primary" />,
      title: "Privacy First",
      description:
        "No browsing data is ever stored. Deterministic scanning is king.",
    },
  ];
          ...
          <div className="space-y-10 order-1 lg:order-2">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-white tracking-tight leading-[1.1]">
                Neutralize threats before you{" "}
                <span className="text-primary italic">click.</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
                Most scams win because of speed. We take that advantage away.
                ScamSentry Shield scans every link as it renders in your
                browser, stopping forensic anomalies in milliseconds.
              </p>
            </div>
