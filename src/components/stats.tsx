      ...
      <div className="container relative px-4 sm:px-6 lg:px-8">
              ...
              >
                <div>
                  ...
                  <dd className="mt-4 text-3xl font-bold tracking-tight text-foreground flex items-baseline gap-1">
                    ...
                    {stat.symbol && (
                      <span className="text-primary text-lg font-semibold">{stat.symbol}</span>
                    )}
                  </dd>
                </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-12 text-xs text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold uppercase tracking-wider">Global Watch Active</span>
          </div>
          <span className="hidden sm:inline text-border">|</span>
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-primary" />
            <span className="font-semibold uppercase tracking-wider">Forensic Integrity Verified</span>
          </div>
        </div>
      </div>
    </section>
