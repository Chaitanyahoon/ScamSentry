        ...
        <div className="mx-auto">
          ...
          {filteredReports.length > 0 ? (
                        ...
                        <td className="p-4 align-middle">
                          <div className="flex items-center gap-2">
                            <span className={cn(
                              ...
                              report.riskLevel === "high" ? "bg-red-500 animate-pulse" : "bg-emerald-500 animate-pulse"
                            )} />
                        ...
                        <td className="p-4 align-middle text-center">
                          <Badge
                            ...
                            className={cn(
                              ...
                              report.riskLevel === "high" && "bg-destructive/10 border-destructive/20 text-destructive",
                              report.riskLevel === "medium" && "bg-warning/10 border-warning/20 text-warning",
                              report.riskLevel === "low" && "bg-muted border-border text-muted-foreground"
                            )}
                          >
                            {report.riskLevel}
                          </Badge>
            ...
            <div className="border border-border p-16 text-center bg-card/45 backdrop-blur-md relative overflow-hidden rounded-2xl">
              ...
              <h3 className="text-sm font-bold uppercase tracking-widest text-foreground mb-2">No Telemetry Found</h3>
