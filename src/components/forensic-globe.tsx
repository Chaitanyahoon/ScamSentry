...
export function ForensicGlobe({ reports: propReports }: ForensicGlobeProps) {
  ...
  const arcs = useMemo(() => {
    const attackSources = [
      ...
      { lat: 19.076, lng: 72.8777, name: "South Asian Vector (Mumbai)" },
    ...
    const targetNodes = [
      ...
      { lat: 52.52, lng: 13.405, name: "Berlin Node" },
      { lat: 28.6139, lng: 77.209, name: "New Delhi Node" },
      ...
      const matchingReport = reports.find(
        (r) =>
          ...
          (normalizedUrl.includes(r.company.toLowerCase()) ||
            ...
            (r.description &&
              r.description.toLowerCase().includes(normalizedUrl))),
      );
